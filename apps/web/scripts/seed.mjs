...
const DEMO_ACTORS = [
  ...
  { name: 'Email Finder', slug: 'email-finder', description: 'Find & verify business emails from a name + company domain. Generates and verifies likely addresses for any domain.', categories: JSON.stringify(['Enrichment', 'Email']), tags: JSON.stringify(['email', 'enrichment', 'verification']), isPublic: true, status: 'PUBLISHED', totalRuns: 0, rating: 0, ratingCount: 0 },
  ...
  { name: 'Contact Enrichment', slug: 'apollo-enrichment', description: 'Enrich leads with verified emails, phone numbers, titles, and company info from our B2B directory.', categories: JSON.stringify(['Enrichment', 'B2B']), tags: JSON.stringify(['enrichment', 'b2b', 'contacts']), isPublic: true, status: 'PUBLISHED', totalRuns: 0, rating: 0, ratingCount: 0 },
